...
item1 = Item(name = "Bustelo", description = "Dark Roast", price = "5.99", category = cat1)
session.add(item1)
session.commit()

item2 = Item(name = "Pico", description = "Medium Roast", price = "1.99", category = cat1)
session.add(item2)
session.commit()
...
item = Item(name = "Soire", description = "Dark Roast", price = "1.99", category = cat3)
session.add(item)
session.commit()

item = Item(name = "Ca Va", description = "Medium Roast", price = "Rs. 20.99", category = cat3)
session.add(item)
session.commit()
...
item = Item(name = "Earl Grey", description = "Classic", price = "6.99", category = cat4)
session.add(item)
session.commit()
